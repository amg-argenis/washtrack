...
public final class ConstantesBaseDatos {
  ...
  public static final String SP_ACTUALIZAR_USUARIO_NOPASSWORD = "SP_ACTUALIZAR_USUARIO_NOPASSWORD";
  ...
  public static final String SP_LISTAR_PROCESOS = "SP_LISTAR_PROCESOS";
